      ...
      <div className="border rounded-md h-[390px] bg-white">
        ...
        <div className="p-3">
          ...
          <div className="w-full flex items-start gap-2 items-center">
            <div className="text-sm text-slate-800 truncate max-w-[70%]">
              {product.brand}
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {product.discountPercentage && (
              <div className="text-xs font-medium bg-amber-300 rounded-md p-1 pl-2 pr-2 mt-1">
                -{product.discountPercentage}%
              </div>
            )}
          </div>
          ...
          {product.stock < LOW_STOCK_BELOW && (
            <div className="text-rose-700	text-sm pt-1 mt-2">
              {product.stock === 1
                ? "Queda 1 unidad"
